                ...
                <div class="p-5">
                  ...
                  <form class="user" action="{{route('login')}}" enctype="application/x-www-form-urlencoded" method="POST">
                    ...
                    <div class="form-group">
                      <input type="email" name="email" class="form-control form-control-user @error('email') is-invalid @enderror" value="{{ old('email') }}" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Your Email Address" >
                      {{-- pesan error --}}
                      @error('email')
